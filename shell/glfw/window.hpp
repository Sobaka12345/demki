#ifndef SHELL_GLFW_WINDOW_HPP
#define SHELL_GLFW_WINDOW_HPP
...
namespace __private {
    ...
    class BaseGlfwWindow : public virtual abstract::IWindow
    {
    private:
    ...
    public:
        BaseGlfwWindow(int clientApi, int width, int height, std::string name);
...
class Window : public ComplexLinearHierarchy<TypeList<GApiT>, 
    SimpleNonLinearHierarchy<
        TypeList<abstract::Window<GApiT>, 
        __private::BaseGlfwWindow>
    >, 
    __private::Window>
{
};
