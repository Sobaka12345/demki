...
BEGIN_DECLARE_VKSTRUCT(DescriptorSetLayoutCreateInfo, VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO)
...
public:
    ...
    DescriptorSetLayout(const Device& device, DescriptorSetLayoutCreateInfo info,
