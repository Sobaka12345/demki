...
void CommandBuffer::bindVertexBuffer(uint32_t firstBinding, uint32_t bindingCount,
...
void CommandBuffer::copyBuffer(VkBuffer src, VkBuffer dst, std::span<const VkBufferCopy> regions) const
{
...
{
    vkCmdCopyBufferToImage(handle(), src, dst, dstLayout,
    ...
    std::span<const VkBufferMemoryBarrier> bufferMemoryBarriers) const
{
    vkCmdPipelineBarrier(
        handle(), srcStageMask, dstStageMask, dependencyFlags,
