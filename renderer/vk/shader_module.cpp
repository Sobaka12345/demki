...
ShaderModule::ShaderModule(const Device &device, std::filesystem::path path, VkHandleType *handlePtr)
...
ShaderModule::ShaderModule(const Device &device, ShaderModuleCreateInfo createInfo, VkHandleType *handlePtr)
    : Handle(handlePtr)
    , m_device(device)
{
